...
destination_dir = "/media/appsmartz/storage/annotation/Kartik_Codes/saxo/"  # Change this to your destination directory
...
def matches_pattern(filename):
    return re.match(r"^Saxophone\d.wav", filename) is not None
